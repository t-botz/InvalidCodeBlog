...
/**
 * <p>Controls <code>String</code> formatting for {@link UnsafeToStringBuilder}.
 ...
 */
public abstract class UnsafeToStringStyle implements Serializable {
     ...
     * example from {@link UnsafeToStringBuilder}, the output would look like this:
     *
     * <pre>
     * Person@182f0db[name=John Doe,age=33,smoker=false]
     * </pre>
     */
    public static final UnsafeToStringStyle DEFAULT_STYLE = new DefaultToStringStyle();
     ...
     * </pre>
     */
    public static final UnsafeToStringStyle MULTI_LINE_STYLE = new MultiLineToStringStyle();

    /**
     * The no field names toString style. Using the Using the
     * <code>Person</code> example from {@link UnsafeToStringBuilder}, the output
     ...
     * </pre>
     */
    public static final UnsafeToStringStyle NO_FIELD_NAMES_STYLE = new NoFieldNameToStringStyle();

    /**
     * The short prefix toString style. Using the <code>Person</code> example
     * from {@link UnsafeToStringBuilder}, the output would look like this:
     *
     * <pre>
     ...
     * @since 2.1
     */
    public static final UnsafeToStringStyle SHORT_PREFIX_STYLE = new ShortPrefixToStringStyle();
     ...
     * </pre>
     */
    public static final UnsafeToStringStyle SIMPLE_STYLE = new SimpleToStringStyle();
     ...
     * @since 2.2
     */
    protected void appendCyclicObject(StringBuilder buffer, String fieldName, Object object) {
        if (object == null) {
     ...
     */
    private static final class DefaultToStringStyle extends UnsafeToStringStyle {
        ...
        private Object readResolve() {
            return UnsafeToStringStyle.DEFAULT_STYLE;
        }
     ...
     */
    private static final class NoFieldNameToStringStyle extends UnsafeToStringStyle {
         ...
         */
        private Object readResolve() {
            return UnsafeToStringStyle.NO_FIELD_NAMES_STYLE;
        }
     ...
     * <code>StandardToStringStyle</code> to ensure its immutability.</p>
     */
    private static final class ShortPrefixToStringStyle extends UnsafeToStringStyle {
         ...
         */
        private Object readResolve() {
            return UnsafeToStringStyle.SHORT_PREFIX_STYLE;
        }
     ...
     * <code>StandardToStringStyle</code> to ensure its immutability.</p>
     */
    private static final class SimpleToStringStyle extends UnsafeToStringStyle {
         ...
         */
        private Object readResolve() {
            return UnsafeToStringStyle.SIMPLE_STYLE;
        }
     ...
     * <code>StandardToStringStyle</code> to ensure its immutability.</p>
     */
    private static final class MultiLineToStringStyle extends UnsafeToStringStyle {
         ...
         */
        private Object readResolve() {
            return UnsafeToStringStyle.MULTI_LINE_STYLE;
        }
